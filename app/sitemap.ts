...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/rechner/budget`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.7 },
    ...
    { url: `${baseUrl}/rechner/nebengewerbe`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.7 },
